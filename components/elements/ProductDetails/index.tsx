...
const relatedProducts = Constants.relatedProducts;
              ...
              <Tab.Panels className="relative aspect-square w-full">
                <Tab.Panel>
                  <Image
                    ...
                    className="founded-lg h-full w-full object-cover object-center"
                  />
                </Tab.Panel>
              </Tab.Panels>
            </Tab.Group>
                  ...
                  <div className="flex items-center">
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        key={rating}
                        className={clsx(
                          product.rating > rating ? 'text-cyan-500' : 'text-gray-300',
              ...
              <form className="mt-6">
                <div className="sm:flex-col1 mt-10 flex">
                  <button
                    ...
                    type="submit"
                    className="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-cyan-600 px-8 py-3 text-base font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full"
                  >
                    Add to bag
                  </button>
